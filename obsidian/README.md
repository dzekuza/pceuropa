...
# 🧠 pceuropa — Project Brain

This vault is the **single source of truth** for `pceuropa`. It documents how the
...
> <!-- One paragraph: what pceuropa is, who it is for, what stage it is at. -->
