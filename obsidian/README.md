...
# 🧠 pceuropa-master — Project Brain

This vault is the **single source of truth** for `pceuropa-master`. It documents how the
...
> <!-- One paragraph: what pceuropa-master is, who it is for, what stage it is at. -->
