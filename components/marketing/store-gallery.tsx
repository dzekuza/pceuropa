  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="relative w-full h-[320px] md:h-[480px] rounded-[32px] lg:rounded-[40px] overflow-hidden bg-[#e8e8e4]">
        ...
        <img
          key={active}
          src={resizeImage(images[active], { width: 1200, height: 960, quality: 90 })}
      ...
      {images.length > 1 && (
        <div className="flex gap-2 overflow-x-auto scrollbar-none">
          {images.map((src, i) => (
            ...
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src={resizeImage(src, { width: 200, height: 144 })} alt="" loading="lazy" className="size-full object-cover" />
            </button>
          ))}
        </div>
      )}
