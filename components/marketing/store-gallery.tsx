...
export function StoreGallery({ images, name }: StoreGalleryProps) {
  ...
  if (images.length === 0) {
    return (
      <div className="relative w-full aspect-square rounded-[32px] lg:rounded-[40px] bg-[#e8e8e4] flex items-center justify-center overflow-hidden">
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* Main image */}
      <div className="relative w-full aspect-square rounded-[32px] lg:rounded-[40px] overflow-hidden bg-[#e8e8e4]">
