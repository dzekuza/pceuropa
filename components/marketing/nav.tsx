      ...
      <div className="max-w-[1332px] mx-auto px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 md:gap-3 lg:gap-4">
          ...
          <div className="hidden md:flex items-center gap-2 lg:gap-3">
            ...
            >
              <img src={resizeImage(timerIconUrl, { width: 48, height: 48, fit: 'contain' })} alt="" className="size-5 lg:size-6 shrink-0 brightness-0 invert" />
            ...
            <div ref={infoRef} className="relative">
              ...
              >
                <img src={resizeImage(infoIconUrl, { width: 48, height: 48, fit: 'contain' })} alt="" className="size-5 lg:size-6 shrink-0" />
              ...
              {isInfoOpen && (
                <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-2xl shadow-lg overflow-hidden z-30">
                  <div className="flex items-center gap-2 px-4 py-3 border-b border-[#E5E5E5]">
                    <img src={resizeImage(infoIconUrl, { width: 48, height: 48, fit: 'contain' })} alt="" className="size-5 shrink-0" />
        ...
        <div className="min-h-0 bg-[#181818]">
          <div className="px-4 pb-5 flex flex-col gap-1">
            ...
            <div className="flex gap-3 mt-4">
              ...
              >
                <img src={resizeImage(timerIconUrl, { width: 48, height: 48, fit: 'contain' })} alt="" className="size-5 brightness-0 invert" />
