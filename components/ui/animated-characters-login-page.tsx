...
export interface AnimatedLoginFormProps {
    onSubmit: (identifier: string, pass: string) => Promise<void>;
    isLoading: boolean;
    error?: string | null;
    strings: {
        title: string;
...
export function AnimatedLoginForm({ onSubmit, isLoading, error, strings }: AnimatedLoginFormProps) {
            ...
            <div className="flex items-center justify-center p-8 bg-background">
                <div className="w-full max-w-[420px]">
                    ...
                    <div className="text-center mb-10">
                        <h1 className="text-3xl font-bold tracking-tight mb-2">{strings.title}</h1>
                        <p className="text-muted-foreground text-sm">{strings.subtitle}</p>
                    </div>

                    <form onSubmit={(e) => { e.preventDefault(); onSubmit(identifier, password); }} className="space-y-5">
                        <div className="space-y-2">
                            <Label htmlFor="identifier" className="text-sm font-medium">{strings.usernameLabel}</Label>
                            <Input
                                id="identifier"
                                type="text"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="password" className="text-sm font-medium">{strings.passwordLabel}</Label>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-2">
                                ...
                                <Label htmlFor="remember" className="text-sm font-normal cursor-pointer">
                                    {strings.rememberMe || 'Prisiminti mane'}
                                </Label>
                            </div>
                        </div>

                        {error && (
                            <div className="p-3 text-sm text-red-500 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900/30 rounded-lg text-center">
                                {error}
                            </div>
                        )}
                        ...
                        <Button
                            ...
                            disabled={isLoading}
                        >
                            {isLoading ? strings.loginInProgress : strings.loginButton}
                        </Button>
                    </form>
                </div>
            </div>
