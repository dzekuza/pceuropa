...
const DEFAULT_BANNER_SLIDES = [
  '/api/storage/marketing-assets/banner-restoranai-1.jpg',
  '/api/storage/marketing-assets/banner-restoranai-2.jpg',
  '/api/storage/marketing-assets/banner-restoranai-3.jpg',
]
