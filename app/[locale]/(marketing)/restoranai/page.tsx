...
import { DialogaiSection, RESTORANAI_SECTION_IMAGES } from '@/components/marketing/dialogai-section'
...
export default async function RestoranaiPage() {
  ...
  const tPage = await getTranslations('restoranaiPage')
  const bannerSlides = await getPuckBannerSlides('restoranai', DEFAULT_BANNER_SLIDES, locale)
  ...
  return (
    <main className="bg-[#f7f7f5] flex flex-col items-center min-h-screen font-[family-name:var(--font-jakarta)]">
      ...
      {/* Dialogai section */}
      <DialogaiSection
        images={RESTORANAI_SECTION_IMAGES}
        heading={t('restoranaiHeading')}
        body={t('restoranaiBody')}
        buttonLabel={t('restoranaiButtonLabel')}
