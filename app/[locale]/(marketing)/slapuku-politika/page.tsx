...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations('slapukuPolitika')
  return {
    title: t('pageTitle'),
...
export default async function SlapukuPolitikaPage() {
  const t = await getTranslations('slapukuPolitika')
  const s = {
    heading: t('heading'),
    ...
    necessaryBody: t('necessaryBody'),
    analyticsLabel: t('analyticsLabel'),
    analyticsBody: t('analyticsBody'),
    marketingLabel: t('marketingLabel'),
    marketingBody: t('marketingBody'),
    controlTitle: t('controlTitle'),
    controlBody: t('controlBody'),
